...
//const apiEndPoint = process.env.API_URI || 'https://dede-en3b-restapi-test2.herokuapp.com/api';
//const solidEndPoint = process.env.SOLIDAPI_URI || 'https://dede-en3b-restapi-test2.herokuapp.com/solid';
