...
const apiEndPoint = process.env.API_URI || 'https://dedeen3b-restapi-test2.herokuapp.com/api';
const solidEndPoint = process.env.SOLIDAPI_URI || 'https://dedeen3b-restapi-test2.herokuapp.com/solid';
